...
<div class="row" style="margin-top: 15px;">
    <div class="col-xs-12 col-md-12 col-lg-12">
        <form action="{{ route('post.changer.password.admin') }}" method="post">
            @csrf
            <div class="main-menu">
                <div class="form-group" style="position: relative;">
                    <label for="password_old">Mật khẩu cũ:</label>
                    <input type="password" class="form-control" placeholder="Enter password" name="password_old" value="{{old('password_old')}}">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <input type="password" class="form-control" placeholder="Comfirm password" name="passwordConfirmation">
                    <a style="position: absolute;top: 33px;right: 14px;" href="javascript:;void(0)"><i
                            class="fa fa-eye"></i></a>
