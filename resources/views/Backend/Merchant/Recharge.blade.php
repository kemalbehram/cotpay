			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<div class="form-group input-group">
						<input class="form-control @error('money') is-invalid @enderror" id="money" name="money" type="text" placeholder="Nhập số tiền cần nạp">
						<span class="input-group-addon">VNĐ</span>
					</div>
					{{-- <input class="form-control @error('money') is-invalid @enderror" id="money" name="money" type="text" > --}}
					@error('money')
...
@section('script')
	<script>
		$('#money').keyup(function () {
			$('#money').val(number_format($(this).val()));
		});
	</script>
@endsection