...
<div class="row">
    <div class="col-lg-12">
        <h5 class="page-headers">
            <a href="{{ route('merchant.index') }}">Trang chủ</a> >> Tạo giao dịch mua
        </h5>
    </div>
</div>
{{-- <div class="menu-label-span ml-3" style="margin-bottom: 15px;">
	<span>S12345678889111</span>
...
<div class="row" style="margin-top: 10px;">
    <div class="col-xs-12 col-md-12 col-lg-12" style="margin-bottom: 15px;">
        <form action="{{ route('post.merchant.buy') }}" method="POST">
            @csrf
            ...
            <div class="col-md-6">
                ...
                @endif --}}
                <div class="form-group " id="self_shipping" name="self_shipping" style="" >
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
