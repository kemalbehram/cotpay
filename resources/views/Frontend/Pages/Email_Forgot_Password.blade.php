        ...
        <tbody>
            ...
            <tr>
                <td
                    ...
                    <img alt="Cot-pay" src="http://cotpay.web88.vn/img/anh.jpg" width="200" height="50"
                        class="CToWUd">
                </td>
            </tr>
            <tr>
                                                ...
                                                <td style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#333333;font-size:15px;font-weight:400;line-height:1.4;padding:15px 5px"
                                                    ...
                                                    <div id="m_-3198625400332445399content">
                                                        <h1 style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;color:#333333;font-size:18px;font-weight:400;line-height:1.4;margin:0;padding:0"
                                                            align="center">Cảm ơn bạn đã đăng ký để sử dụng tài khoản
                                                            Cot-pay!</h1>
                                                        <p>Để lấy lại mật khẩu hãy nhấp vào liên kết dưới đây.
                                                        </p>
                                                        <div>
                                                            <a href="{{ $route }}"
            ...
            <tr>
                <td
                    style="font-family:&quot;Helvetica Neue&quot;,Helvetica,Arial,sans-serif;font-size:13px;line-height:1.6;color:#5c5c5c;padding:25px 0">
                    <img alt="Cot-pay" height="33" src="http://cotpay.web88.vn/img/anh.jpg" width="100"
                        style="display:block;margin:0 auto 1em" class="">
                    <div>
                        Bạn nhận được email này vì bạn có tài khoản trên <a href="http://cotpay.web88.vn"
                            target="_blank">cotpay.web88.vn</a>
                    </div>
                </td>
            </tr>
            <tr>
                <td
                    ...
                    <div>
                        <a style="color:#3777b0;text-decoration:none" href="http://cotpay.web88.vn"
                        ...
                        ·
                        <a style="color:#3777b0;text-decoration:none" href="http://kidsnow.edu.vn"
